...
//    }
	...
	@Test
	void disconnectButton_ClientBecomesDisconnected(FxRobot robot) throws Exception {
		...
		//assertThrows(Exception.class, () -> robot.clickOn("#disconnectButton"));
		robot.clickOn("#disconnectButton");
		assertFalse(app.checkSocketStatus());
		
		//TODO: 
		// https://www.edureka.co/community/4028/how-to-import-a-jar-file-in-eclipse make Server into a runnable jar and import it
		// https://stackoverflow.com/questions/1320476/execute-another-jar-in-a-java-program execute the runnable Server jar from within test
		//hopefully will avoid exceptions generated by Server
		
		//server.stop();
		//app.stop();
	}
	//@Test
	//void disconnectButton_ClientAlreadyDisconnected()
